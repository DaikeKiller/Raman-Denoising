...
if __name__ == "__main__":
    ...
    noise_dir = "data/noise/processed_new/dark_0.1s_222.txt"
    ...
    plt.savefig("results/only_noise_input_pV.jpg")
    
    np.savetxt("tmp/cleaned_signal.txt", cleaned_signal, fmt="%.4f")